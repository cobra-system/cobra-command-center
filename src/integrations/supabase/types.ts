...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      division_products: {
        Row: {
          ...
          monthly_avg_half_year: number | null
          monthly_avg_quarter: number | null
      ...
      frisbee_inspections: {
        Row: {
          ...
          status: string | null
          synced_at: string
          tow_hook_fixed: boolean | null
          tow_hook_retractable: boolean | null
      ...
      import_cost_lines: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "import_cost_lines_included_in_document_id_fkey"
            columns: ["included_in_document_id"]
            isOneToOne: false
            referencedRelation: "purchase_documents"
            referencedColumns: ["id"]
          },
      ...
      products: {
        Row: {
          bonded_stock_delek: number | null
          bonded_stock_karso: number | null
          bonded_stock_lubinsky: number | null
          category: string
          consumption_quarterly: number | null
          created_at: string
          deleted_at: string | null
          description: string | null
          division: string | null
      ...
      purchase_documents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "purchase_documents_import_file_id_fkey"
            columns: ["import_file_id"]
            isOneToOne: false
            referencedRelation: "import_files"
            referencedColumns: ["id"]
      ...
      supplier_monthly_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "supplier_monthly_payments_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "suppliers"
            referencedColumns: ["id"]
      ...
      supplier_payments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "supplier_payments_order_payment_id_fkey"
            columns: ["order_payment_id"]
            isOneToOne: false
            referencedRelation: "order_payments"
            referencedColumns: ["id"]
      ...
      waste_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "waste_items_repair_technician_id_fkey"
            columns: ["repair_technician_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "waste_items_return_item_id_fkey"
            columns: ["return_item_id"]
            isOneToOne: false
            referencedRelation: "equipment_return_items"
            referencedColumns: ["id"]
          },
        ]
      }
      waste_return_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "waste_return_items_return_id_fkey"
            columns: ["return_id"]
            isOneToOne: false
            referencedRelation: "waste_supplier_returns"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "waste_return_items_waste_item_id_fkey"
      ...
      waste_supplier_returns: {
        ...
        Relationships: [
          {
            foreignKeyName: "waste_supplier_returns_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "suppliers"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      load_supplier_payments: { Args: { data: Json }; Returns: number }
