...
/**
 * Where a parsed document came from. "sap-pdf" is the fixed Israeli SAP export,
 * "foreign-doc" a template-free document from an overseas supplier.
 */
export type ImportSource = "sap-pdf" | "spreadsheet" | "foreign-doc";
