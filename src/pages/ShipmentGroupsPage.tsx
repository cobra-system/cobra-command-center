...
import { Ship, Plus, Trash2, ArrowUpDown, ArrowUp, ArrowDown, Package } from "lucide-react";
    ...
    <div className="space-y-6 p-6" dir="rtl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">קבוצות משלוח</h1>
            <p className="text-sm text-muted-foreground">קישור הזמנות המשולחות על אותה אונייה</p>
          </div>
        </div>
        {hasEdit && (
