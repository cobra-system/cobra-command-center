...
export const products: Product[] = [
  { id:"p1", category:"מיגון ואיתור", division:"AWACS", name:"PROOF Z-4K", description:"מערכת צילום וניטור", sku:"z4k", productType:"מוגמר", supplier:"iStarVideo", supplierOrigin:"סין", shipping:"ימי + אווירי", purchasePrice:95, monthlySales:630, monthlyOrder:1600, stockQty:1600, incomingQty:1600 },
  { id:"p2", category:"מיגון ואיתור", division:"AWACS", name:"S400", description:"מערכת צילום וניטור", sku:"s400", productType:"מוגמר", supplier:"iStarVideo", supplierOrigin:"סין", shipping:"ימי + אווירי", purchasePrice:83, monthlySales:105, monthlyOrder:400, stockQty:0, incomingQty:400 },
  ...
  { id:"p5", category:"מיגון ואיתור", division:"AWACS", name:"COBRA Biometric", description:"מערכת התנעה ביומטרית", sku:"biofin", productType:"מורכב", supplier:"CR Team", supplierOrigin:"ישראל, סין", shipping:"אווירי", monthlySales:20, stockQty:0, incomingQty:0, notes:"לעדכן ספירה", components:[
  ...
  { id:"p6", category:"מיגון ואיתור", division:"AWACS, דלק מוטורס, כפתור", name:"מערכת איתור Connect", description:"מערכת ניטור", sku:"5224", productType:"מוגמר", supplierOrigin:"ישראל", shipping:"יבשתי", monthlySales:200, monthlyOrder:300, stockQty:1008, incomingQty:0 },
  { id:"p7", category:"מולטימדיה", division:"AWACS", name:"COBRA BackseatTV1", description:"מערכת מולטימדיה", sku:"cobratv1", productType:"מורכב", supplier:"ACESVision", supplierOrigin:"סין", shipping:"ימי", purchasePrice:232.9, monthlySales:3, stockQty:69, incomingQty:0 },
  { id:"p8", category:"מולטימדיה", division:"AWACS", name:"COBRA BackseatTV2", description:"מערכת מולטימדיה", sku:"cobratv2", productType:"מורכב", supplier:"ACESVision", supplierOrigin:"סין", shipping:"ימי", purchasePrice:140, monthlySales:2, stockQty:0, incomingQty:0 },
  { id:"p9", category:"מולטימדיה", division:"פריזבי קרסו, דלק מוטורס, לובינסקי", name:"מסכי אנדרואיד", description:"מערכת מולטימדיה", sku:"AHM1280A", productType:"מוגמר", supplier:"ACESVision", supplierOrigin:"סין", shipping:"ימי", purchasePrice:130, monthlySales:42, stockQty:63, incomingQty:0 },
  { id:"p10", category:"מולטימדיה", division:"פריזבי קרסו, דלק מוטורס, לובינסקי", name:"אוזניות בלוטוס", description:"אוזניות בלוטוס", sku:"BT100", productType:"מוגמר", supplier:"ACESVision", supplierOrigin:"סין", shipping:"ימי", purchasePrice:7.5, monthlySales:65, stockQty:0, incomingQty:0, notes:"לעדכן ספירה" },
  ...
  { id:"p12", category:"בטיחות", division:"AWACS, כפתור, פריזבי קרסו", name:"Blindspot", sku:"m305", productType:"מוגמר", supplier:"AutoStar", supplierOrigin:"סין", shipping:"ימי", purchasePrice:84, monthlySales:105, monthlyOrder:100, stockQty:0, incomingQty:0, notes:"לעדכן ספירה" },
  { id:"p13", category:"בטיחות", division:"AWACS", name:"AWACS CM 108", sku:"r8", productType:"מורכב", supplier:"A.I Matics", supplierOrigin:"דרום קוריאה", shipping:"ימי", purchasePrice:145, monthlySales:60, stockQty:6, incomingQty:500 },
