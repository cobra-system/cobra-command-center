export type MeetingType = "procurement" | "general" | "other";
...
export type ProcurementDecision = "approved" | "deferred" | "partial" | "pending";

export interface ProcurementMeetingOrder {
  id: string;
  meeting_id: string;
  order_id: string;
