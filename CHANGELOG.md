...
- **עלות ההובלה כמספר עצמאי** — מופרדת ממכס, אגרות ומע"מ, ומוצגת בכותרת המקטע בדף ההזמנה, בכותרת כל תיק ובטאב מסמכי היבוא, בלי צורך לפתוח כלום. לצידה סוג המשלוח (ימי/אווירי) ותעריף ליחידה — לק"ג באווירי, ל-CBM בימי — כי סכום בלבד לא מאפשר להשוות בין משלוחים.
