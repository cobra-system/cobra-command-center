...
- מודול MCP חדש `import-files` עם 12 כלים, ובהם `get_import_file_costs` לעלות נחיתה ו-`find_orders_for_import_file` שמדרג הזמנות מועמדות לפי מזהי משלוח משותפים.
