...
ה-MCP Server של Cobra Command Center מספק **315 כלים** ב-**35 מודולים** לשימוש Claude Code — גישה ישירה לכל ה-DB ללא דרישת ממשק גרפי.
...
| `import-files` | תיקי יבוא ועלות נחיתה | 12 | import_files, import_file_orders, import_cost_lines, purchase_documents |
