...
| תיק הזמנה | `/orders/:id` | פרטים מלאים, ציר זמן Workflow, מסמכים |
| משימות | `/tasks` | לוח קנבן (לביצוע / הושלם) + תצוגה שבועית עם גרירה |
...
| הגדרות | `/settings` | ניהול צוות, תפקידים, נתונים |
